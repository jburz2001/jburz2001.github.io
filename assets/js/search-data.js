...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "Please download my CV by clicking the PDF download button on this page. Future iterations of this site may update this webpage to display my CV without having to download it.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-i-attended-the-2025-structure-preserving-scientific-computing-and-machine-learning-summer-school-and-hackathon-at-the-university-of-washington-seattle-from-06-16-06-25-sponsored-by-the-nsf-while-there-i-studied-dynamical-low-rank-approximations-operator-splitting-and-physics-informed-neural-networks-additionally-i-worked-with-a-scientist-from-lawrence-livermore-national-laboratory-to-implement-a-physics-informed-preconditioner-for-simulating-x-ray-radiative-transport-in-inertial-confiment-fusion",
          title: 'I attended the 2025 Structure–Preserving Scientific Computing and Machine Learning Summer School and...',
          description: "",
