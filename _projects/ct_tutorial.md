...
But why do we need to run the warm--up when starting up a CT machine? Well, if one were to suddenly make the temperature of the electron source filament very high relative to what it was, then there is a risk of it getting damaged. This is like how runners are recommended to stretch before running since they could injure muscles if they suddenly subject them to strenuous exercise without warming up. 
